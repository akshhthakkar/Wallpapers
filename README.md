...
A personal collection of high-quality wallpapers featuring anime characters, movies, and pop culture references.
...
All images are stored using Git LFS for efficient repository management.
...
**Note**: Git LFS must be installed to download the full-resolution images.

## License

Personal collection for personal use.
